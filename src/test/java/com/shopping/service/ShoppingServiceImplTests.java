...
public class ShoppingServiceImplTests {
    ...
    public void testInsert_ShoppingItemInserted() {
        ...
        when(shoppingDao.save(any(ShoppingEntity.class))).thenReturn(new ShoppingEntity());

        ShoppingResponse result = shoppingServiceImpl.insert(shoppingEntity);
    ...
    public void testView_ShoppingItemFound() {
        ...
        ShoppingResponse result = shoppingServiceImpl.view(SHOPPING_ID);
    ...
    public void testViewByProductName_ShoppingItemFound() {
        ...
        List<ShoppingResponse> result = shoppingServiceImpl.viewByProductName(PRODUCT_NAME);
    ...
    public void testViewByCustomerNameOrProductName_ShoppingItemNotFound() {
        ...
        List<ShoppingResponse> result = shoppingServiceImpl.viewByCustomerNameOrProductName(extractName(shopping.getCustomerEmail()), PRODUCT_NAME);
    ...
    public void testViewAll_ShoppingItemsFound() {
        ...
        List<ShoppingResponse> result = shoppingServiceImpl.viewAll();
    ...
    public void testChange_ShoppingItemChanged() {
        ...
        ShoppingRequest updatedEntity = new ShoppingRequest();
        ...
        when(shoppingDao.save(any(ShoppingEntity.class))).thenReturn(existingEntity);

        ShoppingResponse result = shoppingServiceImpl.change(SHOPPING_ID, updatedEntity);
    ...
    public void testChange_ShoppingItemNotFound() {
        ...
        assertThrows(ShoppingCustomNotFoundException.class, () -> shoppingServiceImpl.change(SHOPPING_ID, new ShoppingRequest()));
    }
